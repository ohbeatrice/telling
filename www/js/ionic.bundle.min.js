...
! function () {
    ...
    function y(e) {
        clearTimeout(J), clearTimeout(K), J = setTimeout(function () {
            if (!(tt + 350 > Date.now())) {
                tt = Date.now();
                var t, n = j.getBoundingClientRect(),
                    i = 0;
    ...
    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0-beta.14",
        function (e) {
        ...
        function (e, t, n) {
            ...
            n.Platform = {
                ...
                is: function (e) {
                    if (e = e.toLowerCase(), this.platforms)
                        for (var t = 0; t < this.platforms.length; t++)
                            if (this.platforms[t] === e) return !0;
                    var n = this.platform();
    ...
    ionic.keyboard = {
        ...
        landscape: !1,
        hide: function () {
            clearTimeout(J), clearTimeout(K), clearTimeout(Q), ionic.keyboard.isOpen = !1, ionic.trigger("resetScrollView", {
                target: j
        ...
        st.effect.Animate = {
            ...
            start: function (e, s, a, l, c, u) {
                ...
                var v = function (o) {
                    ...
                    if (m)
                        for (var T = Math.round((g - h) / (i / n)) - 1, E = 0; E < Math.min(T, 4); E++) v(!0), f++;
                    l && (_ = (g - d) / l, _ > 1 && (_ = 1));
                    var S = c ? c(_) : _;
    ...
    ! function (e) {
        ...
        e.views.Scroll = e.views.View.inherit({
            ...
            doTouchEnd: function (t) {
                ...
                var n = this;
                if (n.__isTracking) {
                    if (n.__isTracking = !1, n.__isDragging)
                        if (n.__isDragging = !1, n.__isSingleTouch && n.options.animating && t - n.__lastTouchMove <= 100) {
                            for (var i = n.__positions, r = i.length - 1, o = r, s = r; s > 0 && i[s] > n.__lastTouchMove - 100; s -= 3) o = s;
                            if (o !== r) {
                                var a = i[r] - i[o],
                                    l = n.__scrollLeft - i[o - 2],
                                    c = n.__scrollTop - i[o - 1];
                    ...
                    if (!n.__isDecelerating)
                        if (n.__refreshActive && n.__refreshStart) {
    ...
    function (e) {
        ...
        c.prototype = new l, c.prototype.start = function (o) {
            ...
            if (this._currentDrag && (!this._isDragging && (Math.abs(t.gesture.deltaX) > this.dragThresholdX || Math.abs(this._currentDrag.startOffsetX) > 0) && (this._isDragging = !0), this._isDragging)) {
                ...
                var i = Math.min(0, this._currentDrag.startOffsetX + t.gesture.deltaX); - n > i && (i = Math.min(-n, -n + .4 * (t.gesture.deltaX + n))), this._currentDrag.content.style[e.CSS.TRANSFORM] = "translate3d(" + i + "px, 0, 0)", this._currentDrag.content.style[e.CSS.TRANSITION] = "none"
            }
        ...
        u.prototype = new l, u.prototype._moveElement = function (t) {
            ...
            for (var e, t = this, n = (this._currentDrag.placeholder, Array.prototype.slice.call(this._currentDrag.placeholder.parentNode.children).filter(function (e) {
                ...
                })), i = this._currentDrag.currentY, r = 0, o = n.length; o > r; r++)
                if (e = n[r], r === o - 1) {
            ...
            didScroll: function (e) {
                if (this.isVirtual) {
                    var t = this.itemHeight,
                        n = (this.listEl.children.length, e.target.scrollHeight),
                        i = this.el.parentNode.offsetHeight,
                        r = (e.scrollTop, Math.max(0, e.scrollTop + this.virtualRemoveThreshold)),
                        o = Math.min(n, Math.abs(e.scrollTop) + i + this.virtualAddThreshold),
                        s = Math.floor((o - r) / t),
                        a = parseInt(Math.abs(r / t), 10),
                        l = parseInt(Math.abs(o / t), 10);
...
! function () {
    ...
    var a = {
        ...
        s = angular.module("ionic", ["ngAnimate", "ngSanitize", "ui.router"]),
        c = angular.extend,
        l = angular.forEach,
        u = angular.isDefined,
        d = (angular.isNumber, angular.isString),
        f = angular.element;
    s.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", function (e, t, n, i, o, r, a) {
        function s(o) {
            ...
            var c = s.element = t('<ion-action-sheet ng-class="cssClass" buttons="buttons"></ion-action-sheet>')(s),
                l = f(c[0].querySelector(".action-sheet-wrapper")),
                u = s.cancelOnStateChange ? e.$on("$stateChangeSuccess", function () {
                    s.cancel()
                }) : angular.noop;
        ...
        function e(e, t, n) {
            ...
            function o(e) {
                if (h) {
                    var t = h.startX - e.gesture.center.pageX,
                        n = h.startY - e.gesture.center.pageY,
                        i = "up" === e.gesture.direction || "down" === e.gesture.direction;
            ...
            var s = c({}, {
                ...
                l = ionic.onGesture("dragstart", i, t[0]),
                u = ionic.onGesture("drag", o, t[0]),
                d = ionic.onGesture("dragend", r, t[0]);
        ...
        return e.prototype = {
            ...
            getIndexForScrollValue: function (e, t) {
                var n;
                if (t <= this.dimensions[e].primaryPos)
                    for (;
                        (n = this.dimensions[e - 1]) && n.primaryPos > t;) e--;
                else
                    for (;
                        (n = this.dimensions[e + 1]) && n.primaryPos < t;) e++;
                return e
            ...
            render: function (e) {
                ...
                var n, i = this,
                    o = this.currentIndex >= this.dataSource.getLength();
                if (o || e) {
                ...
                for (n = u;
                    (r = this.dimensions[n]) && r.primaryPos - r.primarySize < c;) t(n, r), n++;
        ...
        return P.prototype.initialize = function (e) {
            ...
            register: function (e, t) {
                ...
                else if (P && P.historyId !== R && m.cursor > -1 && m.stack.length > 0 && m.cursor < m.stack.length && m.stack[m.cursor].stateId === u) {
                ...
                if (p(_), L.backView && R == L.backView.historyId && u == L.backView.stateId && U == L.backView.url)
                    for (a = 0; a < m.stack.length; a++)
                        if (m.stack[a].viewId == _) {
    ...
    var h = '<div class="loading-container"><div class="loading"></div></div>',
        p = "$ionicLoading instance.hide() has been deprecated. Use $ionicLoading.hide().",
        v = "$ionicLoading instance.show() has been deprecated. Use $ionicLoading.show().",
        g = "$ionicLoading instance.setContent() has been deprecated. Use $ionicLoading.show({ template: 'my content' }).";
    s.constant("$ionicLoadingConfig", {
        template: '<i class="icon ion-loading-d"></i>'
    }).factory("$ionicLoading", ["$ionicLoadingConfig", "$ionicBody", "$ionicTemplateLoader", "$ionicBackdrop", "$timeout", "$q", "$log", "$compile", "$ionicPlatform", "$rootScope", function (e, t, n, i, o, r, s, l, u, d) {
        function f() {
            return w || (w = n.compile({
                template: h,
                appendTo: t.get()
            }).then(function (e) {
                var a = e;
        ...
        function m(t) {
            ...
            return k && o.cancel(k), k = o(angular.noop, n), k.then(f).then(function (e) {
                ...
                hide: a.method(p, s.error, $),
                show: a.method(v, s.error, function () {
                    m(t)
                }),
    ...
    s.provider("$ionicPlatform", function () {
        ...
        function o(e, o) {
            var a = angular.element(e.target || e),
                s = t.offset(a),
                c = o.prop("offsetWidth"),
                l = o.prop("offsetHeight"),
                u = n[0].body.clientWidth,
                d = i.innerHeight,
                h = {
                    left: s.left + s.width / 2 - c / 2
                },
                p = f(o[0].querySelector(".popover-arrow"));
            h.left < r ? h.left = r : h.left + c + r > u && (h.left = u - c - r), s.top + s.height + l > d ? (h.top = s.top - l, o.addClass("popover-bottom")) : (h.top = s.top + s.height, o.removeClass("popover-bottom")), p.css({
                left: s.left + s.width / 2 - p.prop("offsetWidth") / 2 - h.left + "px"
            }), o.css({
                top: h.top + "px",
                left: h.left + "px",
                marginLeft: "0",
    ...
    s.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", function (e, t, n, i, o, r, a, s) {
            ...
            function d(e) {
                ...
                var o = w._createPopup(e),
                    a = $[0];
                a && a.hide();
                var c = i(angular.noop, a ? m.stackPushDelay : 0).then(function () {
                    return o
                }).then(function (e) {
                    return a || (r.addClass("popup-open"), t.retain(), w._backButtonActionDone = s.registerBackButtonAction(u, y)), $.unshift(e), e.show(), e.responseDeferred.notify({
                        close: c.close
                    }), e.responseDeferred.promise.then(function (n) {
                        var o = $.indexOf(e); - 1 !== o && $.splice(o, 1), e.remove();
                        var a = $[0];
        ...
        }]), s.service("$ionicScrollDelegate", ionic.DelegateService(["resize", "scrollTop", "scrollBottom", "scrollTo", "scrollBy", "zoomTo", "zoomBy", "getScrollPosition", "anchorScroll", "getScrollView"])), s.service("$ionicSideMenuDelegate", ionic.DelegateService(["toggleLeft", "toggleRight", "getOpenRatio", "isOpen", "isOpenLeft", "isOpenRight", "canDragContent", "edgeDragThreshold"])), s.service("$ionicSlideBoxDelegate", ionic.DelegateService(["update", "slide", "select", "enableSlide", "previous", "next", "stop", "autoPlay", "start", "currentIndex", "selected", "slidesCount", "count", "loop"])), s.service("$ionicTabsDelegate", ionic.DelegateService(["select", "selectedIndex"])),
        function () {
            var e = [];
            s.factory("$ionicTemplateCache", ["$http", "$templateCache", "$timeout", function (t, n, i) {
                ...
                function r() {
                    if (o._runCount++, a = !0, 0 !== s.length) {
                        for (var e = 0; 4 > e && (template = s.pop());) d(template) && t.get(template, {
                            cache: n
                        }), e++;
                        s.length && i(r, 1e3)
                    }
                ...
                t.state = function (o, r) {
                    if ("object" == typeof r) {
                        ...
                        if (a && d(r.templateUrl) && e.push(r.templateUrl), angular.isObject(r.views))
                            for (var s in r.views) a = r.views[s].prefetchTemplate !== !1 && e.length < n.templates.maxPrefetch(), a && d(r.views[s].templateUrl) && e.push(r.views[s].templateUrl)
                    }
                    return i.call(t, o, r)
                }
            ...
            function u(e, t, n, i) {
                var r = s(e),
                    a = v || E(t, "view-transition") || r.viewTransition || o.views.transition() || "ios",
            ...
            var v, g, m = "webkitTransitionEnd transitionend",
                $ = "$noCache",
                w = "$destroyEle",
                b = "$eleId",
                y = "$accessed",
            ...
            var V, E = ionic.DomUtil.cachedAttr,
                A = [],
                D = {
                    create: function (t, l, f, T) {
                        var V, L, P, H = ++x,
                            N = {
                                ...
                                render: function (e, n) {
                                    if (L && ionic.Utils.disconnectScope(L.scope()), P) ionic.Utils.reconnectScope(V.scope());
                                    else {
                                        h(V, B);
                                        var i = u(l, V, e.direction, f),
                                ...
                                transition: function (a, s) {
                                    ...
                                    var k = o.transitions.views[b.transition] || o.transitions.views.none,
                                        _ = k(V, L, b.direction, b.shouldAnimate);
            ...
            h.beforeEnter = function (t) {
                ...
                if ("left" == e) B = "title-left", k && (C = k + 15), T && (I = T + 15);
            ...
            var o = this,
                ...
                a = !1,
                s = !1,
                c = n._registerInstance(o, t.delegateHandle, function () {
            ...
            C.init = function () {
                ...
                var c = n.alignTitle || a.navBar.alignTitle(),
                    h = f("<ion-header-bar>").addClass(n.class).attr("align-title", c);
                u(n.noTapScroll) && h.attr("no-tap-scroll", n.noTapScroll);
                var p, v, g = f('<div class="title title-' + c + '">'),
                    m = {},
                    $ = {};
                ...
                var C = h.data("$ionHeaderBarController"),
                    B = {
                        isActive: o,
                        title: function (e) {
                            C.title(e)
                ...
                var n = C.isInitialized ? p() : h(),
                    i = C.isInitialized ? h() : null,
                    o = n.controller();
            ...
            function u() {
                if (f)
                    for (var e = 0; e < r._instances.length; e++)
                        if (r._instances[e].$$delegateHandle == f) return r._instances[e];
            ...
            var l = c.element = t.el,
                u = c.$element = f(l),
                d = c.scrollView = new ionic.views.Scroll(t);
            ...
            h.$scope = e, h.initialize = function (e) {
                ...
                var t = h.left && h.left.width || 0,
                    n = h.right && h.right.width || 0;
                ...
                var n = h.edgeThresholdEnabled && !h.isOpen(),
                    i = t.gesture.startEvent && t.gesture.startEvent.center && t.gesture.startEvent.center.pageX,
                    o = !n || i <= h.edgeThreshold || i >= h.content.element.offsetWidth - h.edgeThreshold,
                    a = r.backView(),
                    s = p ? !0 : !a;
                if (!s) {
                    var c = r.currentView() || {};
            ...
            var d, f, h, p, v = this,
                g = {},
                m = [],
                $ = e.$on("ionNavBar.init", function (e, t) {
    ...
    var T = "Cannot create a collection-repeat within a scrollView that is scrollable on both x and y axis.  Choose either x direction or y direction.",
        C = "collection-repeat expected attribute collection-item-height to be a an expression that returns a number (in pixels) or percentage.",
        ...
        B = "collection-repeat expected expression in form of '_item_ in _collection_[ track by _id_]' but got '%'";
            ...
            link: function (i, o, r, a, s) {
                function c(e) {
                    ...
                    l(H.children, function (e) {
                        if (ionic.DomUtil.elementIsDescendant(o[0], e, H)) i = !1;
                        else {
                ...
                var p = a[0],
                    v = a[1],
                    g = f('<div style="position:relative;">');
                ...
                var w = n(r.collectionItemHeight || '"100%"'),
                    b = n(r.collectionItemWidth || '"100%"'),
                    y = function (e, t) {
                        var n = w(e, t);
        ...
        return {
            ...
            compile: function (e, i) {
                function o(e, o, a) {
                    ...
                    else if ("true" === i.overflowScroll) o.addClass("overflow-scroll");
                    else {
                        var c = {
                            el: o[0],
                ...
                var r;
                return e.addClass("scroll-content ionic-scroll"), "false" != i.scroll ? (r = f('<div class="scroll"></div>'), r.append(e.contents()), e.append(r)) : e.addClass("scroll-content-false"), {
                    pre: o
                }
            }
        }
        ...
        return {
            ...
            controller: ["$scope", "$attrs", function (e, n) {
                this.isLoading = !1, this.scrollView = null, this.getMaxScroll = function () {
                    var e = (n.distance || "2.5%").trim(),
                        i = -1 !== e.indexOf("%"),
                        o = this.scrollView.getScrollMax();
                    return {
    ...
    var V = '<a class="item-content" ng-href="{{$href()}}" target="{{$target()}}"></a>',
        E = '<div class="item-content"></div>';
    s.directive("ionItem", function () {
        return {
            ...
            compile: function (e, t) {
                var n = angular.isDefined(t.href) || angular.isDefined(t.ngHref) || angular.isDefined(t.uiSref),
                    i = n || /ion-(delete|option|reorder)-button/i.test(e.html());
                if (i) {
                    var o = f(n ? V : E);
    ...
    s.directive("ionReorderButton", ["$parse", function (e) {
        ...
        return {
            ...
            compile: function (t, n) {
                return angular.isUndefined(n.pullingIcon) && n.$set("pullingIcon", "ion-ios7-arrow-down"), angular.isUndefined(n.refreshingIcon) && n.$set("refreshingIcon", "ion-loading-d"),
                    function (t, n, i, o) {
                        e(t, i, {
                            pullingIcon: "@",
                            pullingText: "@",
        ...
        return {
            ...
            controller: ["$scope", "$element", "$attrs", function (t, o, r) {
                var a = t.$eval(t.doesContinue) === !0,
                    s = u(r.autoPlay) ? !!t.autoPlay : !1,
                    c = s ? t.$eval(t.slideInterval) || 4e3 : 0,
        ...
        return {
            ...
            compile: function (r, a) {
                ...
                r.empty();
                var d, h;
                return u && ("ION-NAV-VIEW" === c.children[0].tagName && (d = c.children[0].getAttribute("name"), c.children[0].classList.add("view-container"), h = !0), 1 === u && (c = c.children[0]), h || c.classList.add("pane"), c.classList.add("tab-content")),
                    function (o, r, a, l) {
                        function h() {
        ...
        return {
            ...
            compile: function (e, t) {
                ...
                return l({
                        ...
                        u(e) && n.attr(t, e)
                    }), t.toggleClass && e[0].getElementsByTagName("label")[0].classList.add(t.toggleClass),
                    function (e, t) {
                        var n, i, o, r;
